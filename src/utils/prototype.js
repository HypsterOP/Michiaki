...
const execAll = () => {
  if (RegExp.prototype.hasOwnProperty("execAll")) {
    return console.error(
      "RegExp prototype already includes a value for execAll.  Not overwriting it."
    );
  }

  return (RegExp.prototype.execAll = RegExp.prototype =
...
const includesOf = () => {
  if (String.prototype.hasOwnProperty("includesOf")) {
    return console.error(
      "String prototype already includes a value for includesOf.  Not overwriting it."
    );
  }
...
const includesAll = () => {
  if (String.prototype.hasOwnProperty("includesAll")) {
    return console.error(
      "String prototype already includes a value for includesAll.  Not overwriting it."
    );
  }
